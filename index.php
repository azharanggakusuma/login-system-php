...
<body id="hitam">
    ...
    <header class="bg-primary bg-gradient text-white mb-5" style="height: 100vh;">
        ...
        <div class="container px-4 text-center">
            ...
            <a class="btn btn-light" href="#tentang-saya"><i class="bi bi-folder"></i>&nbsp;Portofolio&nbsp;</a> &nbsp;
            <a class="btn btn-light" href="#" onclick="gantiTema()"><i class="bi bi-brightness-high"></i> Ganti Tema</a>
        </div>
    </header>
    ...
    <div class="container">
        ...
        <div class="col-lg-12 mx-auto">
            ...
            <h1 class="display-4 fw-bold">Galeri Sertifikat <i class="bi bi-award-fill"></i></h1>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div class="bg-white rounded shadow-sm"><img src="img/sertifikat/MTCNA.jpg" alt="" class="img-fluid card-img-top">
            <div class="p-4">
                <h5> <a href="#" class="text-dark">MTCNA</a></h5>
                <p class="small text-muted mb-0">MikroTik Certified Network Associate - MikroTik Academy</p>
        ...
        <!-- Gallery item -->
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div class="bg-white rounded shadow-sm"><img src="img/sertifikat/Juara-3.png" alt="" class="img-fluid card-img-top">
            <div class="p-4">
        ...
        <!-- Gallery item -->
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div class="bg-white rounded shadow-sm"><img src="img/sertifikat/Dasar Pemrograman Web.jpg" alt="" class="img-fluid card-img-top">
            <div class="p-4">
        ...
        <!-- Gallery item -->
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div class="bg-white rounded shadow-sm"><img src="img/sertifikat/CNSS.jpg" alt="" class="img-fluid card-img-top">
            <div class="p-4">
        ...
        <!-- Gallery item -->
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div class="bg-white rounded shadow-sm"><img src="img/sertifikat/CCNAv7.jpg" alt="" class="img-fluid card-img-top">
            <div class="p-4">
        ...
        <!-- Gallery item -->
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div class="bg-white rounded shadow-sm"><img src="img/sertifikat/NDG Linux Essentials.jpg" alt="" class="img-fluid card-img-top">
            <div class="p-4">
        ...
        <!-- Gallery item -->
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div class="bg-white rounded shadow-sm"><img src="img/sertifikat/NDG Linux Unhatched.jpg" alt="" class="img-fluid card-img-top">
            <div class="p-4">
                <h5> <a href="#" class="text-dark">NDG Linux</a></h5>
                <p class="small text-muted mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
                <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
        ...
        <!-- Gallery item -->
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div class="bg-white rounded shadow-sm"><img src="img/sertifikat/PCAP.jpg" alt="" class="img-fluid card-img-top">
            <div class="p-4">
...
<br><br>
    ...
    <h1 class="text-center mt-5" id="kontak">Kontak</h1>
                        ...
                        <div class="row">
                            <div class="col-md-7 pe-0">
                                <div class="form-left h-100 py-5 px-5">
                                    <form action="kontak.php" method="POST" class="row g-4">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="bi bi-chat-right-text-fill"></i></div>
                                                    <textarea class="form-control" rows="3" name="pesan" placeholder="Silahkan masukkan pesan kamu disini..."></textarea>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-5 ps-0 d-none d-md-block">
                                <div class="form-right h-100 bg-primary text-white text-center pt-5">
                                    ...
                                    <h2 class="fs-1">Kirimkan pesan kamu disini!!!</h2><br><br>
                                    <p class="mt-5">info@azharangga-kusuma.my.id</p>
                                </div>
                            </div>
                        </div>
                    </div>
