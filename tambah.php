...
<body>
    <div class="container">
        ...
        <form action="halaman_admin.php" method="post" class="mt-5">
            <div class="mb-3 ">
            ...
            <div class="text-center">
                <input type="submit" value="Tambah" class="btn btn-success"> &nbsp; <a href="halaman_admin.php" class="btn btn-danger">Kembali</a>
            </div>
        </form>
    </div>
</body>
